	...
	public class OffsetEffector : OffsetModifier
	{
		...
		protected override void OnModifyOffset()
		{
			...
			foreach (EffectorLink effectorLink in array)
			{
				...
				ik.solver.GetEffector(effectorLink.effectorType).positionOffset += (a - (ik.solver.GetEffector(effectorLink.effectorType).bone.position + ik.solver.GetEffector(effectorLink.effectorType).positionOffset)) * weight * effectorLink.weightMultiplier;
			}
		}
	}
}
