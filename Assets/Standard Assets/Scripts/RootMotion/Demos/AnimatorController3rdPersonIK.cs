...
namespace RootMotion.Demos
{
	...
	public class AnimatorController3rdPersonIK : AnimatorController3rdPerson
	{
		...
		{
			Quaternion rotation = (!(recoil != null)) ? rightHandRotation : (recoil.rotationOffset * rightHandRotation);
			Vector3 a = ik.references.rightHand.position + ik.solver.rightHandEffector.positionOffset + rotation * leftHandPosRelToRightHand;
			ik.solver.leftHandEffector.positionOffset += a - ik.references.leftHand.position - ik.solver.leftHandEffector.positionOffset + rotation * leftHandOffset;
		}
