...
namespace RootMotion.FinalIK
{
	...
	public class IKSolverFullBodyBiped : IKSolverFullBody
	{
		...
		{
			Vector3 a = Vector3.zero + GetHandBodyPull(leftHandEffector, leftArmChain, Vector3.zero) * Mathf.Clamp(leftHandEffector.positionWeight, 0f, 1f);
			return a + GetHandBodyPull(rightHandEffector, rightArmChain, a) * Mathf.Clamp(rightHandEffector.positionWeight, 0f, 1f);
		}
