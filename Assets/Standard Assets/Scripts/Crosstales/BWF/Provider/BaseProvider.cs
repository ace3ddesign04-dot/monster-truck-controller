...
namespace Crosstales.BWF.Provider
{
	...
	public abstract class BaseProvider : MonoBehaviour
	{
		...
		{
			UnityEngine.Debug.LogWarning("No 'Resources' for " + base.name + " added!" + Environment.NewLine + "If you want to use this functionality, please add your desired 'Resources'.");
		}
	}
}
