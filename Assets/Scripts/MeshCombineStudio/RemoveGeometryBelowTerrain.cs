...
namespace MeshCombineStudio
{
	public class RemoveGeometryBelowTerrain : MonoBehaviour
	{
		...
		public void Remove(GameObject go)
		{
			...
			UnityEngine.Debug.Log("Removeable " + removeTriangles + " total " + totalTriangles + " improvement " + ((float)removeTriangles / (float)totalTriangles * 100f).ToString("F2"));
			UnityEngine.Debug.Log("Skipped Objects " + skippedObjects);
		}
