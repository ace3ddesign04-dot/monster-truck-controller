...
public class TiltShift : PostEffectsBase
{
	...
	public void OnRenderImage(RenderTexture source, RenderTexture destination)
	{
		...
		Vector3 vector = GetComponent<Camera>().WorldToViewportPoint(focalPoint * GetComponent<Camera>().transform.forward + GetComponent<Camera>().transform.position);
		float num3 = distance01 = vector.z / GetComponent<Camera>().farClipPlane;
		start01 = 0f;
		end01 = 1f;
