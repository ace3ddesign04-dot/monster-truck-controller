...
namespace Gaia.FullSerializer.Internal.DirectConverters
{
	public class Rect_DirectConverter : fsDirectConverter<Rect>
	{
		...
		protected override fsResult DoDeserialize(Dictionary<string, fsData> data, ref Rect model)
		{
			...
			success += DeserializeMember(data, "xMin", out value);
			model.xMin = value;
			float value2 = model.yMin;
			success += DeserializeMember(data, "yMin", out value2);
			model.yMin = value2;
			float value3 = model.xMax;
			success += DeserializeMember(data, "xMax", out value3);
			model.xMax = value3;
			float value4 = model.yMax;
			success += DeserializeMember(data, "yMax", out value4);
			model.yMax = value4;
			return success;
		}
