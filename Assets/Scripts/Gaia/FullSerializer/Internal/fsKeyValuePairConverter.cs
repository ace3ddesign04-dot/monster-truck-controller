...
namespace Gaia.FullSerializer.Internal
{
	public class fsKeyValuePairConverter : fsConverter
	{
		...
		public override fsResult TryDeserialize(fsData data, ref object instance, Type storageType)
		{
			...
			fsData subitem;
			fsResult = success += CheckKey(data, "Key", out subitem);
			if (fsResult.Failed)
			{
				return success;
			}
		...
		public override fsResult TrySerialize(object instance, out fsData serialized, Type storageType)
		{
			...
			Type storageType3 = genericArguments[1];
			fsResult success = fsResult.Success;
			success.AddMessages(Serializer.TrySerialize(storageType2, value, out fsData data));
			success.AddMessages(Serializer.TrySerialize(storageType3, value2, out fsData data2));
