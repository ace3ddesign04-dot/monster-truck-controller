...
[Serializable]
public class AGS_MTC_RearSuspensionControls : AGS_MTC_SuspensionControls {
	public AGS_MTC_SuspensionValue ShowArms = new AGS_MTC_SuspensionValue("Show arms", AGS_MTC_ValueType.Int, 0f, 1);
