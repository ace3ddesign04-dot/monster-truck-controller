...
public class AGS_MTC_EngineController : MonoBehaviour
{
    public AGS_MTC_Pulley[] pulleys;

    public AGS_MTC_Pulley ThrottleValve;
    ...
    public AGS_MTC_EngineSounds orcEngineSounds;
    ...
    public float[] Gears {
        get {
            ...
            return AGS_MTC_GearsManager.DefaultGears;
        }
    }
    ...
    private void LoadEngineSounds() {
        if (Diesel) {
            orcEngineSounds = ((GameObject)UnityEngine.Object.Instantiate(Resources.Load("Sounds/DieselTruck"), base.transform.position, Quaternion.identity, base.transform)).GetComponent<AGS_MTC_EngineSounds>();
            Turbo = true;
            ...
            if (_orcTruckController.EngineBlockStage >= 2) {
                orcEngineSounds = ((GameObject)UnityEngine.Object.Instantiate(Resources.Load("Sounds/GasTruckBigBlock"), base.transform.position, Quaternion.identity, base.transform)).GetComponent<AGS_MTC_EngineSounds>();
            }
            else {
                orcEngineSounds = ((GameObject)UnityEngine.Object.Instantiate(Resources.Load("Sounds/GasTruck"), base.transform.position, Quaternion.identity, base.transform)).GetComponent<AGS_MTC_EngineSounds>();
            }
            ...
            orcEngineSounds = ((GameObject)UnityEngine.Object.Instantiate(Resources.Load("Sounds/SideBySide"), base.transform.position, Quaternion.identity, base.transform)).GetComponent<AGS_MTC_EngineSounds>();
            Turbo = false;
            orcEngineSounds.Turbo = false;
        }
        else if (_orcTruckController.vehicleType == AGS_MTC_VehicleType.Crawler) {
            orcEngineSounds = ((GameObject)UnityEngine.Object.Instantiate(Resources.Load("Sounds/Crawler"), base.transform.position, Quaternion.identity, base.transform)).GetComponent<AGS_MTC_EngineSounds>();
            Turbo = false;
            orcEngineSounds.Turbo = false;
        }
        else {
            orcEngineSounds = ((GameObject)UnityEngine.Object.Instantiate(Resources.Load("Sounds/ATV"), base.transform.position, Quaternion.identity, base.transform)).GetComponent<AGS_MTC_EngineSounds>();
            Turbo = false;
            orcEngineSounds.Turbo = false;
        }
    }
    ...
    private void RotatePulleys() {
        if (pulleys != null) {
            AGS_MTC_Pulley[] array = pulleys;
            foreach (AGS_MTC_Pulley pulley in array) {
