...
public class AGS_MTC_IBeamFrontSuspension : AGS_MTC_Suspension {
	public AGS_MTC_FrontIBeamWheel FLWheel;

	public AGS_MTC_FrontIBeamWheel FRWheel;
	...
	public AGS_MTC_IBeamFrontSuspensionControls Controls;
