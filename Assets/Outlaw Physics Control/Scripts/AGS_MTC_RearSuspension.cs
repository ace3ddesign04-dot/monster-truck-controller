...
public class AGS_MTC_RearSuspension : AGS_MTC_Suspension {
	private AGS_MTC_CarController carController;

	public AGS_MTC_RearWheel RLWheel;

	public AGS_MTC_RearWheel RRWheel;
	...
	public AGS_MTC_RearSuspensionControls Controls;
