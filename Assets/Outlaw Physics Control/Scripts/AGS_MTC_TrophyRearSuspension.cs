...
public class AGS_MTC_TrophyRearSuspension : AGS_MTC_Suspension {
	private AGS_MTC_CarController carController;

	private Vector3 RearAxleDummyDefPos;

	public AGS_MTC_RearTrophyWheel RLWheel;

	public AGS_MTC_RearTrophyWheel RRWheel;
	...
	public AGS_MTC_RearTrophySuspensionControls Controls;
	...
	{
		return new AGS_MTC_SuspensionValue[11]
		{
			Controls.AxisWidth,
			Controls.Damping,
	...
	public override void UpdateSuspension(float SteerAngle, float WheelRadius, float rpm)
	{
        ...
        AGS_MTC_RearTrophyWheel rLWheel = RLWheel;
		float deviation = rLWheel.Deviation;
        ...
        AGS_MTC_RearTrophyWheel rRWheel = RRWheel;
