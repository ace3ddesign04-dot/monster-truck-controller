...
public class AGS_MTC_IndiFrontSuspension : AGS_MTC_Suspension {
	private AGS_MTC_CarController carController;

	public AGS_MTC_IndiFrontWheel FLWheel;

	public AGS_MTC_IndiFrontWheel FRWheel;
	...
	public AGS_MTC_IndiFrontSuspensionControls Controls;
	...
	{
		return new AGS_MTC_SuspensionValue[9]
		{
			Controls.AWD,
			Controls.AxisWidth,
			Controls.Damping,
	...
	public override void UpdateSuspension(float SteerAngle, float WheelRadius, float rpm)
	{
        ...
        AGS_MTC_IndiFrontWheel fRWheel = FRWheel;
        ...
        AGS_MTC_IndiFrontWheel fLWheel = FLWheel;
