  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Vert vert(appdata_t in_v)
      {
          ...
          float3 tmpvar_15;
          float _tmp_dvx_6 = max(((1.055 * pow(max(res_11, float3(0, 0, 0)), float3(0.4166667, 0.4166667, 0.4166667))) - 0.055), float3(0, 0, 0));
          tmpvar_15 = float3(_tmp_dvx_6, _tmp_dvx_6, _tmp_dvx_6);
          res_11 = tmpvar_15;
          float tmpvar_16;
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float3 tmpvar_7;
          tmpvar_7 = (_BaseColor * tmpvar_6).xyz;
          ...
          float tmpvar_10;
          tmpvar_10 = float((dirtTex_4.w>=_DirtColor.w));
          dirtFactor_2 = tmpvar_10;
          float _tmp_dvx_7 = (dirtTex_4.w * dirtFactor_2);
          finalColor_5 = (lerp(finalColor_5, dirtColor_3.xyz, float3(_tmp_dvx_7, _tmp_dvx_7, _tmp_dvx_7)) * in_f.xlv_COLOR0);
          float4 tmpvar_11;
          tmpvar_11.w = 1;
