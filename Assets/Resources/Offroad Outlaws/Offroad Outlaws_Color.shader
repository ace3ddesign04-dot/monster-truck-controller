  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Vert vert(appdata_t in_v)
      {
          ...
          float3 tmpvar_14;
          float _tmp_dvx_2 = max(((1.055 * pow(max(res_10, float3(0, 0, 0)), float3(0.4166667, 0.4166667, 0.4166667))) - 0.055), float3(0, 0, 0));
          tmpvar_14 = float3(_tmp_dvx_2, _tmp_dvx_2, _tmp_dvx_2);
          res_10 = tmpvar_14;
          float tmpvar_15;
